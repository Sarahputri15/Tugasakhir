...
<div class="row">
  <div class="col-9">
    <a href="{{ url('/Home/RKKS/Create') }}" class="btn btn-success my-3"><i class="bi bi-plus"></i>Tambah</a>
  </div>
</div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="{{ url('/Home/RKKS/hapus/'.$rencana->id) }}" class="badge bg-danger"><i class="bi bi-x-circle"></i> Hapus</span></a>
        </td>
      </tr>
      @endforeach
    </tbody>
